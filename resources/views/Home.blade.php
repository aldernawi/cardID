...
<body class="g-sidenav-show rtl bg-gray-200 tajawal-bold">
  <style>
        .tajawal-extralight {
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-3 rotate-caret  bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header justify-between ">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
        ...
        <span class="me-1 font-weight-bold text-white">card system</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="{{route('import')}}">
            ...
            <span class="nav-link-text me-1"> الاستيراد</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="{{route('students')}}">
            ...
            <span class="nav-link-text me-1">ادارة الطلبة</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="{{route('subjects')}}">
            ...
            <span class="nav-link-text me-1">ادارة المواد</span>
          </a>
        </li>
        <li class="nav-item">
            <a class="nav-link " href="{{route('exams')}}">
              ...
              <span class="nav-link-text me-1">ادارة الامتحانات</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{route('qr-code')}}">
              ...
              <span class="nav-link-text me-1">قراءة qr-code </span>
            </a>
          </li>
          @else
          <li class="nav-item">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a class="btn bg-gradient-dark mt-4 w-100" href="" type="button"> الرئيسية</a>
      </div>
    </div>
  </aside>
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg overflow-x-hidden">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 ">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">  الرئيسية</li>
          </ol>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 px-0" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end" style="padding-left: 200px">
    ...
    <span class="min-h-screen bg-gray-100"></span>
